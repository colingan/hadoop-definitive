...
public class MaxTemperatureMapperTest {
	...
	public void ignoresMissingTemperatureRecord() throws IOException,
		...
		Text value = new Text(
				"0043011990999991950051518004+68750+023550FM-12+038299999V0203201N00261220001CN9999999N9+99991+99999999999");

		new MapDriver<LongWritable, Text, Text, IntWritable>()
				.withMapper(new MaxTemperatureMapperV2()).withInputValue(value)
				.runTest();
	}
}
